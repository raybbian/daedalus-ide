            ...
            >
                ...
                <div className="w-full flex flex-col gap-1">
                    ...
                    <p className="opacity-75">
                        ...
                        They may be wiped if you clear your browser cache!
                    </p>
                </div>
                <div className="w-full flex flex-col gap-1">
                    <h2 className="text-lg font-bold">Keybind Preset</h2>
                    <p className="opacity-75 text-sm">
                        Keybinds for instructions are given in a 4x4 grid
                        pattern on your physical keyboard. Change this setting
                        if you use an alternate keyboard layout so that this
                        grid pattern is reflected to update your layout.
                    </p>
                        ...
                        {keybindConfigs.map((configName: KeybindConfig, i) => (
                            <div key={i} className="flex flex-row gap-2">
                                <input
                                    ...
                                    value={configName}
                                    checked={
                                        ideConfig.keybindConfig == configName
                                    }
                                    onChange={(e) =>
                                        setIdeConfig({
                                            ...ideConfig,
                                            keybindConfig: e.target
                                                .value as KeybindConfig,
                                        })
                                    }
                                />
