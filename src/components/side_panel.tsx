        ...
        <div className="w-full h-auto bg-daedalus15 px-6 py-4 flex flex-col gap-4">
            <div className="w-full flex flex-col gap-2">
                ...
                <p className="opacity-75">
                    Welcome to the Daedalus Web IDE! To pan the pixel grid,
                    click and drag with your middle mouse button. Color a pixel
                    by left clicking, and remove one by right clicking.
                </p>
                <div className="w-full flex flex-row gap-4 items-center">
                    <Link
                        href={"https://github.com/ambareesh1510/daedalus"}
                        target="_blank"
                    ...
                    <Link
                        href={"https://github.com/raybbian/daedalus-ide"}
                        target="_blank"
                        className="flex flex-row gap-2"
                    >
            ...
            <div className="w-full flex flex-col gap-2">
                ...
                <p className="opacity-75">
                    The left section of the toolbar indicates the selected
                    instruction. The right section consists of a literal value
                    generator that constructs literal values for instructions
                ...
                <div className="text-sm opacity-65 flex flex-col gap-1">
                    ...
                    <div className="list-none flex flex-row gap-2 items-center">
                        ...
                        <p>
                            Toggle the literal value generator between signed
                            and unsigned values.
                        </p>
                    </div>
                </div>
            ...
            <div className="w-full flex flex-col gap-2">
                ...
                <p className="opacity-75">
                    These are the instructions available for use in Daedalus.
                    Note the following:
                </p>
                <ul className="text-sm opacity-65">
                    <li className="list-disc ml-4">
                        All instructions must be prefixed with a instruction
                        marker (or comparison marker).
                    </li>
                    <li className="list-disc ml-4">
                        Instructions that take a parameter are either unsigned
                        or signed (two&apos;s complement), and are entered with
                        their binary representation using colors 0-7 in Little
                        Endian order.
                    </li>
                    <li className="list-disc ml-4">
                        Note that If an overflow occurs, values will wrap around
                        in their range.
                    </li>
                </ul>
            ...
            <div className="w-full flex flex-col gap-2">
                ...
                <p className="opacity-75">
                    Something not working as expected? Check the console for
                    errors. Proper notifications coming soon!
                </p>
            </div>
        </div>
    );
...
function InstructionPicker({
    ...
    return (
        <div className="w-full h-full grid grid-cols-2 grid-rows-8">
            {instructionNamesAndId.map(
                ([instructionName, instructionDesc, id]) => (
                    <InstructionButton
                        key={id}
...
function InstructionButton({
    ...
    return (
        ...
        >
            ...
            <code className="absolute top-1 left-2 opacity-40">
                {instructionId}
            </code>
            <code className="absolute top-1 right-2 opacity-40">
                [{colorToKeyWithConfig(instructionId, ideConfig)}]
            </code>
        </button>
    );
}
