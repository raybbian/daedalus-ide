		...
		<div className="w-full h-auto bg-daedalus15 px-6 py-4 flex flex-col gap-4">
			...
			<div className="w-full flex flex-col gap-2">
				...
				<ul className="text-sm opacity-65">
					...
					<li className="list-disc ml-4">Instructions that take a parameter are either unsigned or signed (two&apos;s complement), and are entered with their binary representation using colors 0-7.</li>
